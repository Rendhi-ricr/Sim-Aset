        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="text-end">
                    ...
                    <a href="<?= site_url('panel/item/tambah') ?>" class="btn btn-primary"><i class="ti ti-plus ti-sm"></i> Tambah</a>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <thead>
                                ...
                                foreach ($item as $key => $value) : ?>
                                    <tr>
                                        ...
                                        <td><a href="<?= base_url('panel/item/' . $value->kode_item) ?>" class="btn btn-warning btn-sm">Edit</a>
